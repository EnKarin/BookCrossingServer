...
public class RefreshService {
    ...
    public AuthResponse updateTokens(final String token) {
        ...
        if (LocalDate.ofEpochDay(refresh.getDate()).isAfter(TimeUtil.dateNow())) {
    ...
    public AuthResponse createTokens(final String login) {
        ...
        user.setLoginDate(TimeUtil.getEpochSeconds());
        ...
        refresh.setDate(TimeUtil.dateNow().plusDays(15).toEpochDay());
