alter table bookcrossing.t_attach add column book_id integer;
...
update bookcrossing.t_attach set book_id = attach_id;
alter table bookcrossing.t_attach alter column book_id set not null;
